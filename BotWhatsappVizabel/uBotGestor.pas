...
begin
  try
      ...
      AConversa.mediaKey      := AMessagem.mediaKey;
      AConversa.deprecatedMms3Url      := AMessagem.mediaKey;

      //Tratando o tipo do arquivo recebido e faz o download para pasta \BIN\temp
      case AnsiIndexStr(UpperCase(AConversa.&type), ['PTT', 'IMAGE', 'VIDEO', 'AUDIO', 'DOCUMENT']) of
        0: begin injectDecrypt.download(AConversa.deprecatedMms3Url, AConversa.mediaKey, 'mp3', AConversa.id); end;
        1: begin injectDecrypt.download(AConversa.deprecatedMms3Url, AConversa.mediaKey, 'jpg', AConversa.id); end;
        2: begin injectDecrypt.download(AConversa.deprecatedMms3Url, AConversa.mediaKey, 'mp4', AConversa.id); end;
        3: begin injectDecrypt.download(AConversa.deprecatedMms3Url, AConversa.mediaKey, 'mp3', AConversa.id); end;
        4: begin injectDecrypt.download(AConversa.deprecatedMms3Url, AConversa.mediaKey, 'pdf', AConversa.id); end;
      end;

      //AConversa.UrlImgProfile := AMessagem.chat.contact.profilePicThumb;
